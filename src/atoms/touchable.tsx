...
import { backgroundColor, BackgroundColorProps, backgroundColorShorthand, BackgroundColorShorthandProps, border, BorderProps, composeRestyleFunctions, opacity, OpacityProps, ResponsiveValue, ThemeContext, useResponsiveProp, useRestyle, useTheme } from '@shopify/restyle';
import { Theme } from '../themes';

type RestyleProps = BackgroundColorProps<Theme> & BackgroundColorShorthandProps<Theme> & BorderProps<Theme>
& OpacityProps<Theme>
